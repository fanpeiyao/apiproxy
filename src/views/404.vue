  ...
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">很抱歉页面不小心迷路了...</div>
...
export default {
  ...
  computed: {
    message() {
      return "I'm sorry that the page got lost accidentally..."
    }
  }
}
</script>
