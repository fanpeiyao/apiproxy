    ...
    <div class="app-container">
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <template slot-scope="scope">
                ...
                <el-button @click="onDel(scope.row)" type="text"  v-permission="['admin']" size="small">删除</el-button>
            </template>
            </el-table-column>
        </el-table>
...
<el-dialog title="新增通知接口" class='addConf' :visible.sync="addFormVisible">
    ...
    :autosize="{ minRows:10}"/>
        ...
        <!-- <el-form-item class='properties' :label="'接口附加参数' + (index+1)" :label-width="formLabelWidth"  v-for="(item, index) in addForm.properties"  :key="item.index">
            ...
            <i v-if=" addForm.properties.length<55" class='el-icon-plus' @click='addProps("addForm")'></i>
...
<el-dialog title="编辑通知接口" class='addConf' :visible.sync="upFormVisible">
  ...
  :autosize="{ minRows:10}"/>
                ...
                <!-- <el-form-item class='properties'
                    :label="'接口附加参数' + (index+1)"
                    :label-width="formLabelWidth"
                    v-for="(item, index) in updateForm.properties"
                ...
                <el-input v-model="item.key"   size="small" autocomplete="off" placeholder="请输入key" ></el-input>
                <el-input v-model="item.value" size="small" autocomplete="off" placeholder="请输入value" ></el-input>
                    <i v-if=" updateForm.properties.length<50" class='el-icon-plus' @click='addProps("updateForm")'></i>
...
export default {
  ...
  data() {
    ...
    methods: {
        ...
        onUpdateForm(row) {
            console.log(row);
            console.log(row.properties.length );
